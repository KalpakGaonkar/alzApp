            ...
            db.child("users").child(user.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot)
                {
                    ...
                    if (geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER)
                    {
                        ...
                        DatabaseReference db = FirebaseDatabase.getInstance().getReference();
                        System.out.println("Patient has entered geofence");
                        db.child("geofences").child(patient.getCaregiverUid()).child(patient.getUid()).child("flag").setValue("enter");
                    ...
                    else
                    {
                        ...
                        DatabaseReference db = FirebaseDatabase.getInstance().getReference();
                        db.child("geofences").child(patient.getCaregiverUid()).child(patient.getUid()).child("flag").setValue("exit");
